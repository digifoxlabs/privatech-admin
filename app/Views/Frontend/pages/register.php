        ...
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <span class="text-danger mb-1"><?= validation_show_error('name') ?></span>
                    ...
                    <div class="input-group mb-3">
                        <input type="email" class="form-control" name="email" value="<?php echo $session->getTempdata('default_email') ? $session->getTempdata('default_email') : set_value('email') ?>"  placeholder="Email">
                        <div class="input-group-append">
                            <div class="input-group-text">
                    ...
                    <div class="input-group mb-3">
                        <input type="number" class="form-control" name="mobile" value="<?php echo $session->getTempdata('default_mobile') ? $session->getTempdata('default_mobile') : set_value('mobile') ?>" placeholder="Mobile Number">
                        <div class="input-group-append">
                            <div class="input-group-text">
                ...
                <div class="social-auth-links text-center mb-2">
                    <a href="<?= base_url('/') ?>" class="btn btn-primary btn-sm">I already have a membership</a>
                </div>
            </div>
            <!-- /.form-box -->
        </div><!-- /.card -->
