...
<head>
  ...
  <?=link_tag('public/assets/common/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css')?>  
  
  <!-- iCheck -->
  <?=link_tag('public/assets/common/plugins/icheck-bootstrap/icheck-bootstrap.min.css')?>  
  
  <!-- JQVMap -->
  <?=link_tag('public/assets/common/plugins/jqvmap/jqvmap.min.css')?>  
  
  <!-- Theme style -->
  <?=link_tag('public/assets/common/dist/css/adminlte.css')?>  
