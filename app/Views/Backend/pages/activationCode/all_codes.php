    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <!-- form start -->
                <form role="form" action="<?= base_url('admin/activationCodes/createCode') ?>" method="post">
                    <div class="card-body">
    ...
    <div class="modal-dialog">
        <div class="modal-content bg-light">
            ...
            <div class="modal-body">
                ...
                <form action="<?= base_url('admin/activationCodes/deleteCode') ?>" method="post">
...
$(document).ready(function() {
    ...
    var dataTable = $('#dataTable').DataTable({
        ...
        scrollCollapse: true,
        ajax: {
            url: site_url + "/admin/activationCodes/ajaxCallAllCodes", // json datasource
            type: "post",
            data: function(data) {
